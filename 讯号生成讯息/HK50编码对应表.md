...
| 编码 | 描述 | 標示 | 數據 |
| --- | --- | --- | --- |
| HK50.33 | CN 商品的多空計算 <br /><br />[doc](https://github.com/ff-logging/ff-service-info/blob/main/doc/Requirement.md#2025-10-17) <br />`CN_COMMODITY_POSITION` | 🔴$\color{red}{商品空倉}🟢$\color{green}{商品多倉} | |
| HK50.34 |  | | |
| HK50.35 |  | | |
| HK50.36 |  | | |
| HK50.37 |  | | |
