...
| 编码 | 描述 | 標示 | 數據 |
| --- | --- | --- | --- |
| HK50.66 | - 計算出共同趨勢/獨立趨勢<br />- HSI有放量趨勢時，找出同時有放量的商品<br />- 計算上漲趨勢中，是最溢價的放量(向上阻力)<br />　還是次溢價的放量(持續向上)<br />- 計算下跌趨勢中，是最折價的放量(向下阻力)<br />　還是次折價的放量(持續向下) <br /><br /><small>文檔: [📃预测方向和投注25W29](https://app.diagrams.net/#G1xDIu9fJM4KXW3kCZqe0GOSSOdPgx_T-k#%7B%22pageId%22%3A%22FSvx7b8tBY5een7PsRQn%22%7D)</small><br /><small>編碼: `TRS_BIND_WITH_TREND`</small> | 🔵  $\color{gray}{同趨}$ : 四個板塊趨勢比效相似<br />🔵  $\color{white}{差趨}$ : 四個板塊趨勢相差比較大<br />🟡  $\color{black}{挷定}$ : HSI有趨勢及商品放量的列表<br />🔵  $\color{green}{<板塊><順序>}$ : 上漲放量的期貨及上漲的順序(0為最溢價)<br />🔵  $\color{red}{<板塊><順序>}$ : 下跌放量的期貨及下跌的順序(0為最折價) | LIVE: <br />[數據](http://192.168.25.240:3020/symbolmonitor/datasets/TRS_BIND_WITH_TREND) <br /><br />DEV: <br />[數據](http://192.168.25.201:3051/symbolmonitor/datasets/TRS_BIND_WITH_TREND) |
| HK50.67 | - 計算出共同趨勢/獨立趨勢<br />- HSI有放量趨勢時，找出同時有放量的商品<br />- 計算上漲趨勢中，是最溢價的放量(向上阻力)<br />　還是次溢價的放量(持續向上)<br />- 計算下跌趨勢中，是最折價的放量(向下阻力)<br />　還是次折價的放量(持續向下) <br /><br /><small>文檔: [📃预测方向和投注25W29](https://app.diagrams.net/#G1xDIu9fJM4KXW3kCZqe0GOSSOdPgx_T-k#%7B%22pageId%22%3A%22FSvx7b8tBY5een7PsRQn%22%7D)</small><br /><small>編碼: `TRS_BIND_WITH_TREND`</small> | 🔵  $\color{gray}{同趨}$ : 三個期貨趨勢比效相似<br />🔵  $\color{white}{差趨}$ : 三個期貨趨勢相差比較大<br />🟡  $\color{black}{挷定}$ : HSI有趨勢及商品放量的列表<br />🔵  $\color{green}{<指數><順序>}$ : 上漲放量的期貨及上漲的順序(0為最溢價)<br />🔵  $\color{red}{<指數><順序>}$ : 下跌放量的期貨及下跌的順序(0為最折價) | LIVE: <br />[數據](http://192.168.25.240:3020/symbolmonitor/datasets/TRS_BIND_WITH_TREND) <br /><br />DEV: <br />[數據](http://192.168.25.201:3051/symbolmonitor/datasets/TRS_BIND_WITH_TREND) |
