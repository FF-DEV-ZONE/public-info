...
| 编码 | 描述 | 標示 | 數據 |
| --- | --- | --- | --- |
| HK股: [HK50.26](http://192.168.25.90:9999/?symbol=HK50.26) <br/> CN商品: [HK50.25](http://192.168.25.90:9999/?symbol=HK50.25) | - 計算比較長時間沒波動的產品 <br />- 監控較長時間沒波動的產品有沒有放量及趨勢<br /><br />[`震盪及帶量部分`](https://app.diagrams.net/#G1zweYaQm0VtQylXZs7GZ4_XtByzBFOaAA#%7B%22pageId%22%3A%22bYwJFpl9Zw2r6N42lS6M%22%7D) [`中性及分離部分`](https://app.diagrams.net/#G1zweYaQm0VtQylXZs7GZ4_XtByzBFOaAA#%7B%22pageId%22%3A%22WtaZLbPsDBsO-VB9nKf1%22%7D)<br />`OSCILLATING_MONITOR_HK_STOCK` `OSCILLATING_MONITOR_CN_COMMODITY` <sub>`test`</sub>| 統計: 計算整天有比較長時間震盪的產品<br />數量: 整天統計的數量<br />升: 放量上升的產品比較多的地方<br />跌: 放量下跌的產品比多的地方 | |
