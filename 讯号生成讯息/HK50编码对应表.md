...
| HK50.36 | 從`HK50.38`的分組中,打出A,H股的放量組<br/>- 有高相關性以及有大放量的產品<br/>- 找出分開是內部/外部的放量 <br /><br />[`doc`](https://app.diagrams.net/#G1WNE3X2lKY97UtBCWNp8tW45LS_LySav5#%7B%22pageId%22%3A%2242a0BJNC6LIr1qJjyErz%22%7D) <br />`ZYJ_GROUP_CALC_PRODUCT_PICKER` `ZYJ_GROUP_CALC`|  | |
