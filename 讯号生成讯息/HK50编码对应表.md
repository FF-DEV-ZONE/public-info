...
### HSI 3 個期貨量的相加方法
$ HSIF_{V} $ = $ {HSI_P \times HSI_V \over HSI_P} + {HHI_P \times HHI_V \over HSI_P} + {HTI_P \times HTI_V \over HSI_P} + {1 \over 5} \cdot {MHI_P \times MHI_V \over HSI_P} + {1 \over 5} \cdot {MCH_P \times MCH_V \over HSI_P} $
